...
namespace Import.FastReports
{
    ...
    public class Form1 : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "FastReport.Net Template:";
            // 
            // btnConvert
            // 
            ...
            this.Text = "Convert FastReport.Net to Stimulsoft Reports";
        ...
        private void btnConvert_Click(object sender, System.EventArgs e)
        {
            ...
            {
                MessageBox.Show("Incorrect FastReport.Net template file name",
            ...
            else
            {
                ...
                log.CloseLog();
                log.OpenLog("Open FastReports template file ...");
                Application.DoEvents();
