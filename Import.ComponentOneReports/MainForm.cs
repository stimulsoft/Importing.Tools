...
namespace Import.ComponentOneReports
{
    ...
    public class Form1 : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "ComponentOne Reports Template:";
            // 
            // btnConvert
            // 
            ...
            this.Text = "Convert ComponentOne Reports to Stimulsoft Reports";
        ...
        {
            openFileDialog1.Title = "Select ComponentOne Reports file";
            openFileDialog1.Filter = "ComponentOne Reports file (*.xml)|*.xml";
        ...
        private void btnConvert_Click(object sender, System.EventArgs e)
        {
            ...
            {
                MessageBox.Show("Incorrect ComponentOne Reports template file name",
            ...
            else
            {
                ...
                log.CloseLog();
                log.OpenLog("Open ComponentOne Reports template file ...");
                Application.DoEvents();
                ...
                foreach (XmlNode node in doc.DocumentElement.ChildNodes)
                {
                    if (node.NodeType != XmlNodeType.Comment)
                    {
                        ...
                        helper.ProcessRootNode(node, report, errorList, 0);
                        ...
                        {
                            savePath = Path.GetDirectoryName(savePath) + "\\" + StiNameValidator.CorrectName(report.ReportName) + ".mrt";
                        }
