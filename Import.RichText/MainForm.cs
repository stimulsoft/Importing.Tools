...
namespace Import.Rtf
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button btnBrowseRichTextFormat;        
		private System.Windows.Forms.Button btnBrowseStimulReport;
		private System.Windows.Forms.TextBox tbRichTextFormat;
		...
		private void InitializeComponent()
		{
            ...
            this.btnBrowseRichTextFormat = new System.Windows.Forms.Button();
            this.btnBrowseStimulReport = new System.Windows.Forms.Button();
            this.openFileDialog1 = new System.Windows.Forms.OpenFileDialog();
            this.saveFileDialog1 = new System.Windows.Forms.SaveFileDialog();
            this.tbRichTextFormat = new System.Windows.Forms.TextBox();
            ...
            this.SuspendLayout();
            // 
            // btnBrowseRichTextFormat
            // 
            this.btnBrowseRichTextFormat.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
            this.btnBrowseRichTextFormat.Location = new System.Drawing.Point(643, 39);
            this.btnBrowseRichTextFormat.Name = "btnBrowseRichTextFormat";
            this.btnBrowseRichTextFormat.Size = new System.Drawing.Size(24, 20);
            this.btnBrowseRichTextFormat.TabIndex = 2;
            this.btnBrowseRichTextFormat.Text = "...";
            this.btnBrowseRichTextFormat.Click += new System.EventHandler(this.btnBrowseRichTextFormat_Click);
            // 
            ...
            // tbRichTextFormat
            // 
            this.tbRichTextFormat.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)
                        | System.Windows.Forms.AnchorStyles.Right)));
            this.tbRichTextFormat.Location = new System.Drawing.Point(9, 39);
            this.tbRichTextFormat.Name = "tbRichTextFormat";
            this.tbRichTextFormat.Size = new System.Drawing.Size(633, 20);
            this.tbRichTextFormat.TabIndex = 1;
            // 
            // tbStimulReportFile
            // 
            ...
            this.label1.Text = "Rich Text File:";
            // 
            // btnConvert
            // 
            ...
            this.groupBox1.Controls.Add(this.btnBrowseRichTextFormat);
            this.groupBox1.Controls.Add(this.btnBrowseStimulReport);
            this.groupBox1.Controls.Add(this.tbRichTextFormat);
            ...
            this.Text = "Convert Rich Text Format to Stimulsoft Reports";
        ...
        private void btnBrowseRichTextFormat_Click(object sender, EventArgs e)
        {
            openFileDialog1.Title = "Select Rich Text Format file";
            ...
            if (openFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                tbRichTextFormat.Text = openFileDialog1.FileName;
            }
        }
		...
		{
            if (!File.Exists(tbRichTextFormat.Text))
            {
                MessageBox.Show("Incorrect Rich Text Format file name",
            ...
            else
            {
                ...
                log.OpenLog("Open RichText file ...");
                Application.DoEvents();

                byte[] buf = File.ReadAllBytes(tbRichTextFormat.Text);
                ...
                var result = StiRtfHelper.Import(buf);
                StiReport report = result.Report;
        ...
        private void FillLog(IStiTreeLog log, StiReport report)
        {
            foreach (StiPage page in report.Pages)
            {
                log.OpenNode(page.Name);

                log.WriteNode(string.Format("Page Margins:  Left:{0}  Right:{1}  Top:{2}  Bottom:{3}",
                    Math.Round(page.Margins.Left, 2),
                    Math.Round(page.Margins.Right, 2),
                    Math.Round(page.Margins.Top, 2),
                    Math.Round(page.Margins.Bottom, 2)));
                log.WriteNode("Page Orientation: ", page.Orientation);
                log.WriteNode(string.Format("Bands: {0}, Components: {1}", page.Components.Count, page.GetComponents().Count));
